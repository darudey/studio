...
// This is a Client Component. It receives all its data as props from the parent
// Server Component and handles all user interactions.
export default function ProductDetailsClient({ product, similarProducts }: { product: Product, similarProducts: Product[] }) {
                        ...
                        <CarouselItem key={index}>
                            <div className="aspect-square relative bg-white">
                                <Image
                                    ...
                                    priority={index === 0} // Prioritizing the first image helps LCP.
                                />
                            </div>
                        </CarouselItem>
                    ))}

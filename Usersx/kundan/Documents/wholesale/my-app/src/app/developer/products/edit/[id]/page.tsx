...
import { useAllProducts, useProduct } from "@/hooks/use-swr-data";
...
export default function EditItemPage() {
  ...
  const { products: allProducts, isLoading: allProductsLoading } = useAllProducts();
  ...
  const isLoading = productLoading || allProductsLoading || authLoading;
  ...
  useEffect(() => {
    ...
    if (!authLoading && user && !['developer', 'shop-owner', 'imager'].includes(user.role)) {
